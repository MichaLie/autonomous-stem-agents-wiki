...
OUTPUTS = {
    ...
    "autonomous-agents": [
        ...
        "docs/robots.txt",
        "docs/sitemap.xml",
        "docs/deprecated_ids.json",
        "docs/deprecated_ids.schema.json",
...
def run_build(commands: list[list[str]]) -> None:
    ...
    if Path("deprecated_ids.json").is_file():
        shutil.copyfile("deprecated_ids.json", "docs/deprecated_ids.json")
        shutil.copyfile("deprecated_ids.schema.json", "docs/deprecated_ids.schema.json")
